package com.beradeep.aiyo.ui.components.topbar
...
import com.beradeep.aiyo.ui.components.topbar.TopBarDefaults.TopBarHeight
import com.beradeep.aiyo.ui.contentColorFor
import com.beradeep.aiyo.ui.foundation.systemBarsForVisualComponents
...
@Stable
data class TopBarColors(val containerColor: Color, val scrolledContainerColor: Color) {
    @Composable
    ...
    @Composable
    internal fun contentColor(colorTransitionFraction: Float): Color = lerp(
