package com.beradeep.aiyo.ui.basics.components.textfield.base
...
class TextFieldColors(
    ...
    fun copy(
        ...
        unfocusedContainerColor = unfocusedContainerColor.takeOrElse {
        ...
        focusedLeadingIconColor = focusedLeadingIconColor.takeOrElse {
            this.focusedLeadingIconColor
        },
        unfocusedLeadingIconColor = unfocusedLeadingIconColor.takeOrElse {
            this.unfocusedLeadingIconColor
        },
        disabledLeadingIconColor = disabledLeadingIconColor.takeOrElse {
            this.disabledLeadingIconColor
        },
        errorLeadingIconColor = errorLeadingIconColor.takeOrElse { this.errorLeadingIconColor },
        focusedTrailingIconColor = focusedTrailingIconColor.takeOrElse {
            this.focusedTrailingIconColor
        },
        ...
        focusedPlaceholderColor = focusedPlaceholderColor.takeOrElse {
            this.focusedPlaceholderColor
        },
        unfocusedPlaceholderColor = unfocusedPlaceholderColor.takeOrElse {
            this.unfocusedPlaceholderColor
        },
        disabledPlaceholderColor = disabledPlaceholderColor.takeOrElse {
        ...
        errorSupportingTextColor = errorSupportingTextColor.takeOrElse {
    ...
    private fun TextSelectionColors?.takeOrElse(
