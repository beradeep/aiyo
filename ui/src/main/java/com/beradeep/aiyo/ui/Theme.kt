...
@Composable
fun AiyoTheme(isDarkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
...
@Composable
fun contentColorFor(color: Color): Color = AiyoTheme.colors.contentColorFor(color)
